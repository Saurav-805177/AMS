...
<div class="page-banner" style="background-color:#444;background-image: url(../assets/uploads/<?php echo $banner_registration; ?>);height: 70px;">
    <div class="inner" style="text-align:center;">
        <h1 style="color:red; " ><?php echo LANG_VALUE_16; ?></h1>
    </div>
</div>
<section class="content-header">
    
    <div class="content-header-right">
        <a href="student_view.php" class="btn btn-primary btn-sm">View All</a>
    </div>
</section>
<div class="page">
    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <input type="text" class="form-control" name="s_name" value="<?php if(isset($_POST['s_name'])){echo $_POST['s_name'];} ?>">
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for=""><?php echo LANG_VALUE_94; ?><span style="color:red;">*</span></label>
                                    <input type="email" class="form-control" name="s_email" value="<?php if(isset($_POST['s_email'])){echo $_POST['s_email'];} ?>">
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for=""><?php echo LANG_VALUE_104; ?><span style="color:red;">*</span></label>
                                    <div class="form-group ">
                                        <input type="text" class="form-control" placeholder="Primary Mobile Number" name="s_phone1" maxlength="10" max="10"  pattern="[0-9]{10}" value="<?php if(isset($_POST['s_phone1'])){echo $_POST['s_phone1'];} ?>">
                                    </div>
                                    <div class="form-group">
                                ...
                                <hr size="8" width="100%" color="red"> 
                                 ...
                                 <div class="col-md-6 form-group">
                                    ...
                                    <div class="" style="padding-top:5px">
                                        <input type="file" name="uploadfile" id="uploadfile" value="<?php if(isset($_POST['uploadfile'])){echo $_POST['uploadfile'];} ?>">(Only jpg, jpeg, gif and png are allowed)
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <textarea name="s_10th_s_name" class="form-control" cols="20" rows="2" style="height:70px;"><?php if(isset($_POST['s_10th_s_name'])){echo $_POST['s_10th_s_name'];} ?></textarea>
                                </div>
                                <div class="col-md-2 form-group">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <label for="">School Name<span style="color:red;">*</span></label>
                                    <textarea name="s_12th_s_name" class="form-control" cols="20" rows="2" style="height:70px;"><?php if(isset($_POST['s_12th_s_name'])){echo $_POST['s_12th_s_name'];} ?></textarea>
                                </div>
                                <div class="col-md-2 form-group">
                                    <label for="">Name of Board/University<span style="color:red;">*</span></label>
